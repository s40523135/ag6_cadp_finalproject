...
\hypersetup{
            pdfauthor={設計二甲 40523125 張志雲; 設計二甲 40523126 張博鈞; 設計二甲 40523127 張皓然; 設計二甲 40523134 陳鵬暉; 設計二甲 40523135 湯科爾; 設計二甲 40523136 黃胤瑋},
            pdfborder={0 0 0},
            breaklinks=true}
...
\fontsize{24}{36}\selectfont{電腦輔助設計實習 ag6 期末報告\par}
\vspace{1.5cm}
\fontsize{20}{30}\selectfont{
    鋼球運動機構設計-球哥\par
    marble machine design\par
}
\vspace{\fill}
\fontsize{18}{27}\selectfont{
    學生：\par
    設計二甲 40523125 張志雲 \par 設計二甲 40523126 張博鈞 \par 設計二甲 40523127 張皓然 \par 設計二甲 40523134 陳鵬暉 \par 設計二甲 40523135 湯科爾 \par 設計二甲 40523136 黃胤瑋 \par
    指導教授：嚴家銘\par
}
\vspace{1.5cm}
\fontsize{16}{24}\selectfont{2017.12.21\par}
\end{center}
\vspace{1cm}
\end{titlepage}
...
\fontsize{14}{21}\selectfont{這裡是摘要內容。張博鈞很帥.

本研究的重點在於 利用本學期學 的東西用小組的方式做出一個鋼
球運動系統，利用的工具有 Solvespace、Onshape、V-rep等..
畫出機構及軌道最後模擬出鋼球 在機構和軌道中的運動狀況

首先我們先從網路上尋找適合的 參考機構，經小組討論決定後利
用Solvespace畫出機構運動的方式 ，成功劃出可以讓鋼球上升的機
構後我們利用Onshape劃出機構 的實體以及每個組員的軌道，
最後用V-rep模擬出鋼球運動系 統}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.6564/0792ac642936e8570ca737e205060752895ed133.jpg}
\caption{camelnooo\label{fig:駱駝}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.6564/e0ef408d9559203849a0aa26f79f9b032b709c7a.png}
